...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <main className="grid min-h-screen bg-paper px-4 py-6 lg:grid-cols-[1fr_440px] lg:gap-8 lg:px-8">
      <section className="hidden min-h-[calc(100vh-3rem)] rounded-lg border border-slate-200 bg-white p-8 shadow-card lg:flex lg:flex-col lg:justify-between">
        <div>
          <Logo />
          <h1 className="mt-10 max-w-xl font-display text-5xl font-semibold tracking-tight text-ink">
            A calmer way to study from the materials your class actually uses.
          </h1>
        </div>
