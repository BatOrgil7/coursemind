# CourseMind — Competitor Research
...
2. **Students themselves are worried about what it's doing to them.** 67% of students said
   ...
   "am I actually learning?" **That worry is CourseMind's entire brand.**
...
- **Takeaway:** CourseMind must never compete on "access to a smart model" — it competes on
...
- **Takeaway:** Quizlet owns "memorize terms." CourseMind owns "understand *my course* and
  pass *my professor's* exam" — quizzes generated from the actual lecture materials.

#### Chegg / Course Hero — the cautionary tales
- Chegg: $15.95/mo, expert Q&A + textbook solutions; in free-fall (see §1). Course Hero:
...
- **Takeaway:** their decline validates the thesis — answer-vending is commoditized to zero.
  Their remaining moat (document libraries) is exactly what CourseMind's *shared course
...
- **Read:** Anthropic is selling *institutions* a general assistant. CourseMind is a
...
- **Takeaway:** they prove instructors will adopt per-course community tools at scale.
  CourseMind's Phase 2 discussion boards + AI-in-thread is this category, modernized —
...
## 4. What CourseMind must do (strategic implications)
